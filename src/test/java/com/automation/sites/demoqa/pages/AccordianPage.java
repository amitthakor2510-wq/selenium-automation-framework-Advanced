...
public class AccordianPage {
    ...
    // ── Section headers ────────────────────────────────────────────────────────
// Located by text content — reliable regardless of ID changes
    ...
    // ── Wait for page to load using a reliable locator ─────────────────────────
    // Use the first heading text directly since ID may vary
    ...
    public void navigateToAccordian() {
        ...
        // Wait for URL to confirm navigation succeeded
        wait.until(ExpectedConditions.urlContains("accordian"));

        // Wait for any accordion element to appear
        // Using text that definitely exists on the page
